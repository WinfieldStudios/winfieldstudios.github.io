...
function clickOnRock(event) {
  ...
  div.innerHTML = `+${formatNumberWithCommas(Math.round(rocksPerClick))}`;
  ...
  switch (upgradeGalmi.level) {
    ...
    case 5: // rock hard dude (stern / intense)
      voicelines = [
        ...
        "Malph just R Flashed. I must have a 6PEK!",
    ...
    case 6: // giga chad gym bro (supportive hype)
      voicelines = [
        ...
        "YOUR NEXT STEP IS WORLD DOMINATION RIGHT?",
        "ROCK ON!",
